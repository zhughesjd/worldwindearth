...
public class Support {
	public static enum KMLTag{name,description, coordinates, id, futurevisibility, north,east,south,west, futurehref, href, xmlns, kml, MultiGeometry, Folder, targetId, namespaceURI, address, ExtendedData, phoneNumber, Snippet, styleUrl, visibility, LatLonAltBox, minFadeExtent, maxFadeExtent, minLodPixels, maxLodPixels, open, altitudeMode}
